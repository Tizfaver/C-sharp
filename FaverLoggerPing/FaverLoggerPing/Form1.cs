        ...
        private void Pinging()
        {
            ...
            if (cliccato == true)
                ...
                try
                {
                    ...
                    if (checkbox_view_failure.Checked == false)
                    {
                        ...
                        if (checkbox_write.Checked == true)
                            ...
                            {
                                sw.WriteLine("[OK " + DateTime.Now.ToString("hh:mm:ss") + "] ping to '" + txt_host.Text + "' in " + result.RoundtripTime + "ms");
                                sw.Close();
                            }
                ...
                catch
                {
                    ...
                    if (checkbox_write.Checked == true)
                    {
                        sw.WriteLine("[ERROR " + DateTime.Now.ToString("hh:mm:ss") + "] could not PING!");
                        sw.Close();
                    }
